...
class ShadowActivity : AppCompatActivity() {
    lateinit var binding: ActivityShadowBinding
...
// Add the request to the RequestQueue.
        ...
        binding.head.back.setOnClickListener { finish() }
...
// Set the selection based on the index of the item in the graphics list
        ...
        val adapter1 =
            ArrayAdapter.createFromResource(this, R.array.Distance, R.layout.spinner_dropdown_item)
        // Specify the layout to use when the list of choices appearss
...
// Define an adapter for the spinner
        ...
        val adapter3 =
            ArrayAdapter.createFromResource(this, R.array.Move, R.layout.spinner_dropdown_item)
        // Specify the layout to use when the list of choices appearss
...
// Define an adapter for the spinner
        ...
        val adapter4 =
            ArrayAdapter.createFromResource(this, R.array.Text, R.layout.spinner_dropdown_item)
        // Specify the layout to use when the list of choices appearss
                ...
                mAdManagerInterstitialAd?.fullScreenContentCallback =
                    object : FullScreenContentCallback() {
                        override fun onAdDismissedFullScreenContent() {
                            ...
                            val customLayout = LayoutInflater.from(this@ShadowActivity)
                            ...
                            val builder = AlertDialog.Builder(this@ShadowActivity)
                            ...
                            Handler().postDelayed(
                                {
                                    ...
                                    if (g == "Smooth") {
                                        ...
                                        val customLayout =
                                            LayoutInflater.from(this@ShadowActivity)
